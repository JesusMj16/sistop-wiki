    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'memoria/admin', lazy: lazyPage(() => import('./pages/notes/AdminMemoria')) },
          ...
          { path: 'arquitectura/sistema-archivos', lazy: lazyPage(() => import('./pages/notes/ArquitecturaFS')) },
          { path: 'arquitectura/estructura-logica', lazy: lazyPage(() => import('./pages/notes/EstructuraLogicaFS')) },
          { path: 'arquitectura/inodos', lazy: lazyPage(() => import('./pages/notes/InodosFS')) },
          { path: 'arquitectura/tipos-archivos', lazy: lazyPage(() => import('./pages/notes/TiposArchivos')) },
          { path: 'arquitectura/dispositivos-io', lazy: lazyPage(() => import('./pages/notes/DispositivosIO')) },
          { path: 'arquitectura/ioctl-disco', lazy: lazyPage(() => import('./pages/notes/IoctlYDisco')) },
          { path: 'signal/introduction', lazy: lazyPage(() => import('./pages/notes/Senales')) },
          { path: 'signal/tipos-senales', lazy: lazyPage(() => import('./pages/notes/TiposSenales')) },
        ],
      },
    ],
  },
